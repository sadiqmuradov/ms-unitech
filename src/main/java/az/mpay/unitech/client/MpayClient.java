...
import az.mpay.unitech.model.request.client.UserCoinSerialReq;
import az.mpay.unitech.model.response.client.UserCoinSerialResp;
import az.mpay.unitech.model.response.client.UserInfoResp;
import az.mpay.unitech.model.response.client.WalletInfoResp;
